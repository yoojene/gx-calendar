    ...
    refreshHeader() {
        ...
        for (let x = 1; x < 7; x++) {
            monthHeader.push({
                ...
                isPast: true,
                isToday: hooks(this.viewDate).date() === hooks(this.firstVisibleDate).date() ? true : false,
                isFuture: false,
                inMonth: true,
                isWeekend: hooks(this.firstVisibleDate).add(x, 'd')
                    .day() === 0 ||
                    hooks(this.firstVisibleDate).add(x, 'd')
                        .day() === 6
                    ? true
                    : false,
            });
        ...
        return h("div", { class: "cal-month-view" },
            h("div", { class: "cal-month-view--container" },
                h("div", { class: "cal-prev-month" },
                    h("button", { onClick: () => this.prevMonth() },
                        ' ',
                        "Previous Month",
                        ' ')),
